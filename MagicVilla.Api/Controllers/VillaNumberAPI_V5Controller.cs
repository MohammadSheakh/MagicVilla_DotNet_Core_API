...
namespace MagicVilla.Api.Controllers
{
    ...
    [ApiController]
    public class VillaNumberAPI_V5Controller : ControllerBase
    {
     
        private readonly ApplicationDbContext _db;
        private readonly IMapper _mapper;
        private readonly IVillaNumberRepositoryV2 _dbVillaNumber;
        protected APIResponse _response;
        public VillaNumberAPI_V5Controller(
            //in constructor we will get that with dependency injection
            ApplicationDbContext db, // we are not using it here 
            IMapper mapper,
            IVillaNumberRepositoryV2 dbVillaNumber // lets call that
            )
        {
